-- German translation // Lousyplayer 2020-12
...
tipsMap = {
	...
	-- ST Nuke -> Single Target Nuke; Hoher Schaden auf Einzelziel
	-- MT Nuke -> Multi Target Nuke; Hoher Schaden auf mehrere Ziele
	[172995] = {{"Important", ""}}, -- Hydra Seed
	-- 167206 Yanlar
	-- 174922 Stratege Zo'rak
	-- 164567 Ingra Maloch
	[164567] = {{"Important", "Focus auf Droman bis 20%. Ingra aus dem Kampf halten, um den Schaden zu maximieren."},
				{"Important", "Hat Droman wenig Leben, dann stunnt sie Ingra und erhöht für 12s seinen erlittenen Schaden auf 200%. Alle DPS Cooldowns ziehen und Burst Damage."},
				{"Dodge", "Ausweichen: blauer kegelförmiger Ausstoss vom Boss & Wirbel auf dem Boden."},
				{"Interrupts", "Unterbrechen (!): Geistblitz - geht auf beliebiges Ziel, ST Nuke."},
				{"HEALER", "In der Burst Phase ebenfalls Schaden austeilen. Alles zählt und der eingehende Schaden ist gering!"},
				}, -- Ingra Maloch
	[170217] = {{"Important", "Minigame bei 70, 40 und 10%. Tötet den Klon, der sich durch Form, Kreis oder Ausfüllung unterscheidet."},
				{"Important", "Form: Blatt vs Blume. Ausfüllung: Formen können entweder 'gefüllt' oder 'leer' sein. Kreis ist selbsterklärend."},
				{"Important", "(Mythic) Boss bleibt da, kämpft weiter und erhält 100% reduzierten Schaden, bis das Spiel vorbei ist."},
				{"Important", "Cooldowns aufsparen für die 10% und Burst Damage bis zum Exitus, bevor das 3. Minigame startet."},
				{"Important", "Unterbrechen(!!!): Klatschspiel. Wird den Tank in zwei Hälften zerreisen. MUSS vom Tank selbst unterbrochen werden."},
				{"Dodge", "Berührt einen der weiße Fuchs, kommt ein AoE freeze. Am besten CC, und natürlich kiten."}}, -- Mistcaller // Nebelruferin
	[172312] = {{"Important", "DEN GRÜNEN WIRBELN AUSWEICHEN. Sie werden Dich runterschubsen. Mit dem Rücken zur Brücke positionieren, falls möglich."}}, -- Spinemaw Gorger // Stachelschlundfresser
	[164501] = {{"Important", "Minigame bei 70, 40 und 10%. Tötet den Klon, der sich durch Form, Kreis oder Ausfüllung unterscheidet."},
				{"Important", "Form: Blatt vs Blume. Ausfüllung: Formen können entweder 'gefüllt' oder 'leer' sein. Kreis ist selbsterklärend."},
				{"Important", "(Mythic) Boss bleibt da, kämpft weiter und erhält 100% reduzierten Schaden, bis das Spiel vorbei ist."},
				{"Important", "Cooldowns aufsparen für die 10% und Burst Damage bis zum Exitus, bevor das 3. Minigame startet."},
				{"Important", "Unterbrechen(!!!): Klatschspiel. Wird den Tank in zwei Hälften zerreisen. MUSS vom Tank selbst unterbrochen werden."},
				{"Dodge", "Ausweichen: Berührt einen der weiße Fuchs, kommt ein AoE freeze. Am besten CC, und natürlich kiten."}}, -- Mistcaller // Nebelruferin
	[164517] = {{"Important", "Gedankenverbindung: Schnell von einander weg bewegen, um die Verbindung zu lösen"},
				{"Important", "Kiten und DPS auf die Larven. In einer späteren Boss-Phase fixieren sie einen Spieler - am besten zum Tank bringen."},
				{"Important", "Unterbrechen (!!): Parasitär X (Besänftigt / lähmt / kontrolliert einen Spieler - abhängig von der Phase)."},
				{"Dodge", "Ausweichen: : grüne und blaue Pfützen. Grüne Pfützen entstehen, wenn eine Larve stirbt."}}, -- Tred'ova
	[166301] = {{"Important", "Mittlerer Tank Schaden."}}, -- Mistveil Stalker // Nebelschleierpirscher
	[167111] = {{"Important", "Unterbrechen(!!): Widerstand stimulieren (absorbiert große Menge an AoE, kann gereinigt werden)"},
				{"Important", "Unterbrechen(!!): Regeneration anregen (großer AoE Heal)"}}, -- Spinemaw Staghorn // Stachelschlundzottelhorn
	[173655] = {{"Important", "Platziert eine große Pfütze, die heilt - Lache des Glanzes. Den Mob UNBEDINGT dort rausziehen."},
            	{"Important", "Castet kegelförmige AoE nach vorne - Strahlender Atem. Tank sollte ausweichen sobald Zauber beginnt."}}, -- Mistveil Matriarch // Nebelschleiermatriarchin
	[164804] = {{"Important", "Focus auf Droman bis 20%. Ingra aus dem Kampf halten, um den Schaden zu maximieren."},
				{"Important", "Hat Droman wenig Leben, dann stunnt sie Ingra und erhöht für 12s seinen Schaden auf 200%. Alle DPS cooldowns ziehen und burst damage."},
				{"Dodge", "Ausweichen: blauer kegelförmiger Ausstoss vom Boss & Wirbel auf dem Boden."},
				{"Interrupts", "Unterbrechen (!): Geistblitz - geht auf beliebiges Ziel, ST Nuke."},
				{"HEALER", "In der Burst Phase ebenfalls Schaden austeilen. Alles zählt und der eingehende Schaden ist gering!"},
				}, -- Droman Oulfarran // Dromanin Oulfarran
	[173720] = {{"Important", "Alle verteilen. Lauft 4+ m weg vom Boss, wenn er Giftige Absonderungen zaubert."},
				{"Important", "Nicht vorm Mob stehen, Castet Zungenschläge - kegelförmiger Radius, Schaden und verringert Bewegungsgeschwindigkeit."}
	           }, -- Mistveil Gorgegullet // Nebelschleierschlingrachen
	[167116] = {{"Important", "Patroullieren in der Gegend. Früh pullen, damit sie einen nicht überraschen."},
				{"Important", "Vergiftet zufällige Spieler - Reinigen, wenn möglich."}}, -- Spinemaw Reaver // Stachelschlundhäscher
	[164920] = {{"Important", "Reinigen: Seelenspaltung (Erhöht den erlittenen Schaden - GEFÄHRLICH)"},
				{"Tank", "Mob bufft sich selbst mit 'Hand von Thros', am Besten kiten, damit die Selbstheilung nicht zieht."},
				{"HEALER", "Den Debuff Seelenspaltung so schnell wie möglich reinigen, oder der Tank wird massiv Heilung benötigen."}
				}, -- Drust Soulcleaver // Drustseelenspalter
	[165108] = {{"Important", ""}}, -- Illusionary Clone
	[166304] = {{"Important", "Verteilen, wenn man Animainjektion Debuff hat (kreisförmige AoE um den Spieler)."}}, -- Mistveil Stinger // Nebelschleierstecher
	[167113] = {{"Important", "Weg von anderen, wenn man den Debuff Flüchtige Säure hat. Kann mit niedriger Prio gekickt werden - es gibt wichtigere."}}, -- Spinemaw Acidgullet // Stachelschlundsäurerachen
	[165512] = {{"Important", ""}}, -- Cocoon of Lakali
	[172992] = {{"Important", ""}}, -- Overgrown Hydra
	[165251] = {{"Important", "LAUF WEG. CC ist möglich beim Fuchs."}}, -- Illusionary Vulpin // Illusionärer Vulpin
	[164929] = {{"Dodge", "GROSSER FRONTALER KEGEL. Zaubert 'Befremdlicher Pollen' - verursacht Schaden und desorientiert."},
            	{"Important", "Spinnt zufälligen Spieler ein. Wird durch Schaden aufgehoben."},
				{"Important", "Wird freundlich ab 20% und wirkt Heilung und Mana Reg"},
				{"HEALER", "Die Disorientierung kann gereinigt werden - wir beide wissen, dass es mindestens einen DPS erwischt."}}, -- Tirnenn Villager // Tirnenneinwohner
	[164921] = {{"Interrupts", "Unterbrechen(!): Essenzernte (AoE Kanalisiert + Heilung"}}, -- Drust Harvester // Drusternter
	[167117] = {{"Dodge", "Hinterlässt einen Säure-Pool beim Tod."}}, -- Spinemaw Larva // Stachelschlundlarve
	[166276] = {{"Important", "Aufbäumendes Toben kann gekickt werden beim ersten cast."}}, -- Mistveil Guardian // Nebelschleierwächter
	[166299] = {{"Important", "Unterbrechen(!): Waldpflege (Grosser AoE HoT, kann gereinigt / geraubt werden)"}}, -- Mistveil Tender // Nebelschleierhüterin
	[164926] = {{"Important", "Bei 2er Packs: Focus Damage auf einen, da sie bei 50% 'Wütendes Hauen' casten - einen AoE Schaden, dem man nicht ausweichen kann"}}, -- Drust Boughbreaker // Drustzweigbrecher
	[165560] = {{"Important", ""}}, -- Gormling Larva
	[166275] = {{"Important", "Unterbrechen(!!): Stacheldornumschlingung (AoE Schaden und macht bewegungsunfähig)."}}, -- Mistveil Shaper // Nebelschleierformer
	[173714] = {{"Important", ""}}, -- Mistveil Nightblossom
	[170229] = {{"Important", "Focus auf Droman bis 20%. Ingra aus dem Kampf halten, um den Schaden zu maximieren."},
				{"Important", "Hat Droman wenig Leben, dann stunnt sie Ingra und erhöht für 12s seinen Schaden auf 200%. Alle DPS cooldowns ziehen und burst damage."},
				{"Dodge", "Ausweichen: blauer kegelförmiger Ausstoss vom Boss & Wirbel auf dem Boden."},
				{"Interrupts", "Unterbrechen (!): Geistblitz - geht auf beliebiges Ziel."},
				{"HEALER", "In der Burst Phase ebenfalls Schaden austeilen. Alles zählt und der eingehende Schaden ist gering!"}
				}, -- Droman Oulfarran // Dromanin Oulfarran
	[165111] = {{"Important", "Explodiert beim Tod, Verflucht beim Tod Spielercharaktere und Kreaturen - 10% mehr Schaden. Stacks."},
				{"Important", "Castet den DoT Aderlass. Am Besten verteilen"}}, -- Drust Spiteclaw // Drustteufelsklaue
	[163058] = {{"Important", "Besänftigen: 'Wut des Beschützers' (+50% Damage buff)"},
				{"Important", "Ist kein 'Besänftigen' verfügbar, den Mob zuerst töten, da er den Buff vom Tod seiner Verbündeten bekommt."},
				{"Important", "Frontal Aufteilen"}, {"TANK", "Rauslaufen aus 'Speerhagel', sobald der Cast beginnt."}}, -- Mistveil Defender // Nebelschleierverteidigerin
	[171772] = {{"Important", "Besänftigen: 'Wut des Beschützers' (+50% Damage buff)"},
				{"Important", "Ist kein 'Besänftigen' verfügbar, den Mob zuerst töten, da er den Buff vom Tod seiner Verbündeten bekommt."},
				{"Important", "Frontal Aufteilen"}, {"TANK", "Rauslaufen aus 'Speerhagel', sobald der Cast beginnt."}}, -- Mistveil Defender // Nebelschleierverteidigerin
	[172991] = {{"Important", "Dispel: 'Seelenspaltung' (Erhöht den erlittenen Schaden um 20%)"},
				{"Tank", "Der Mob bufft sich mit 'Hand von Thros', am besten kiten währenddessen, um die Selbstheilung zu unterbinden."}}, -- Drust Soulcleaver // Drustseelenspalter
	[168988] = {{"Important", "Verbündete raushauen! Schnell! Er verliert DPS!"}}, -- Overgrowth // Wildes Wachstum
	[173680] = {{"Important", "+10% Primärwerte für 10 Minuten."}}, -- Savory Statshroom // Würziger Wertpilz
	[165120] = {{"Dodge", "GROSSER FRONTALER KEGEL. Zaubert 'Befremdlicher Pollen' - verursacht Schaden und desorientiert."},
            	{"Important", "Spinnt zufälligen Spieler ein. Wird durch Schaden aufgehoben."},
				{"Important", "Wird freundlich ab 20% und wirkt Heilung und Mana Reg"},
				{"HEALER", "Die Disorientierung kann gereinigt werden - wir beide wissen, dass es mindestens einen DPS erwischt."}}, -- Tirnenn Villager // Tirnenneinwohner
	[170218] = {{"Important", "Focus auf Droman bis 20%. Ingra aus dem Kampf halten, um den Schaden zu maximieren."},
				{"Important", "Hat Droman wenig Leben, dann stunnt sie Ingra und erhöht für 12s seinen Schaden auf 200%. Alle DPS cooldowns ziehen und burst damage."},
				{"Dodge", "Ausweichen: blauer kegelförmige Ausstoss vom Boss & Wirbel auf dem Boden."},
				{"Interrupts", "Unterbrechen (!): Geistblitz - geht auf beliebiges Ziel."},
				{"HEALER", "In der Burst Phase ebenfalls Schaden austeilen. Alles zählt und der eingehende Schaden ist gering!"},
				}, -- Droman Oulfarran // Dromanin Oulfarran
	[172647] = {{"Important", ""}}, -- Parasitic Infestor
	[173679] = {{"Important", "+10% Ausdauer für 10 Minuten."}}, -- Tasty Toughshroom // Leckerer Lederpilz
	[167707] = {{"Important", "Dawww"}}, -- Tirnenn Sapling // Tirnennsetzling
	...
	[164450] = {{"Important", "Die Fallen auf dem Boden schleudern Euch in die Höhe. Reinlaufen, wenn:"},
				{"Important", "- Man hat den Bomben Debuff und noch 2s Zeit ('Ortsgebundene explosive Vorrichtung' ODER"},
				{"Important", "- Der Boss Spruch 'Explosive Vorrichtung' endet in 2s."}}, -- Dealer Xy'exa // Händlerin Xy'exa
	[166473] = {{"Important", "Adds fixieren Spieler - Fokussieren, aber entfernt vom Boss töten, da diese eine giftige Lache hinterlassen."},
				{"Important", "Adds: Heilungszauber unterbrechen"},
				{"Important", "Betroffene von 'Verderbtes Blut' (roter Kreis) aus der Gruppe laufen."},
				{"Important", "DPS cooldowns aufheben für die 'Blutbarriere' Phase. Unterbrecht 'Blutbeschuss' sobald das Schild weg ist."}
				}, -- Hakkar the Soulflayer // Hakkar der Seelenschinder
	[101976] = {{"Important", "SEHR hoher Tank Schaden. Defensiv-Fähigkeiten aufheben für hohe Stacks mit Blutung."},
				{"Important", "Erzeugt 'Experimentelle Eichhörnchenbombe' - anklicken zum Entschärfen - werursachen hohen Flächenschaden."},
				{"Important", "Hat man einen blauen Kreis um einen, dann zu Millificent laufen, um Sie zu betäuben. Resettet die Blutungen beim Tank."}
				}, -- Millificent Manastorm
	[169905] = {{"Important", "Besänftigen: 'Unvergängliche Wut' (Kann sonst nicht getötet werden und Schaden um 100% erhöht)"},
				{"Dodge", "Dem roten Wirbelwind ausweichen. Gefährlich."}}, -- Risen Warlord // Auferstandener Kriegsherr
	[164861] = {{"Important", "Unterbrechen: Borkenrüstung (Geringe Schadensreduzierung)"}}, -- Spriggan Barkbinder // Sprigganborkenbinder
	[170147] = {{"Important", ""}}, -- Volatile Memory
	[171184] = {{"Important", "Mini-boss kann übersprungen werden - äußerst rechts halten."},
				{"Important", "'Klagende Trauer': Verängstigt 3s und verursacht Schaden"}}, -- Mythresh, Sky's Talons // Mythresh, Krallen des Himmels
	[168934] = {{"Important", "Haltet Euch nicht mit dem killen der Masken auf. Es ist leichter den Wirbeln auszuweichen."},
				{"Important", "'Wut' ist ein mächtiger kanalisierter AoE. Zauber kann unterbrochen werden, ansonsten Verteidungs-Cooldowns ziehen."},
				{"PriorityTargets", "Priority Target"}}, -- Enraged Spirit // Wütender Geist
	[170490] = {{"Important", "Unterbrechen (!): Heilung (...)"},
				{"HEALER", "Dispel 'Schattenwort: Schmerz'."}}, -- Atal'ai High Priest // Hohepriester der Atal'ai
	[164558] = {{"Important", "Adds fixieren Spieler - Fokussieren, aber entfernt vom Boss töten, da diese eine giftige Lache hinterlassen."},
				{"Important", "Adds: Heilungszauber unterbrechen - Fokus auf Söhne Hakkars"},
				{"Important", "Betroffene von 'Verderbtes Blut' (roter Kreis) von der Gruppe weglaufen."},
				{"Important", "DPS cooldowns aufheben für die 'Blutbarriere' Phase. Unterbrecht 'Blutbeschuss' sobald das Schild weg ist."},
				{"Important", "Bei 100 Energie bekommt Hakkar durch 'Blutbarriere' ein Schild. Zerstört diesen durch Schaden und " ..
				              "weicht den vielen roten Flächen auf dem Boden aus. Unterbrecht danach den Boss."}
				}, -- Hakkar the Soulflayer // Hakkar der Seelenschinder
	[174327] = {{"Important", ""}}, -- Mask of Bwonsamdi
	[164556] = {{"Important", "In den Strahl der Kristalle stellen - verursacht Schaden, aber man erhält dmg buff."},
				{"Important", "'Fingerlaser Echo X-trem' betroffene Spieler: Lauft zu beiden Seiten von Millhouse, um ihn zu betäuben."},
				{"Dodge", "Weglaufen vom Laser nachdem er gefeuert hat, um die Betäubung zu vermeiden."}}, -- Millhouse Manastorm // Millhaus Manasturm 
	[171342] = {{"Important", ""}}, -- Juvenile Runestag
	[164862] = {{"Important", "Springen, um den Fluch zu entfernen. Kann auch entflucht werden. Nicht gefährlich."}}, -- Weald Shimmermoth // Waldschimmermotte
	[167962] = {{"Important", "Defekter Zahnbohrer - Geht schnell aus der Sichtlinie (versteckt euch irgendwo hinter), wenn Durchgebrannt eingesetzt wird (Großer AoE Schaden)."}}, -- Defunct Dental Drill // Defekter Zahnbohrer
	...
	[168942] = {{"Important", "Reinigen / Stehlen (!!): Umarmung des Todes (100% Tempo)"},
				{"Important", "Ausbrechende Dunkelheit stößt alle in Zauberrichtung zurück. Dem Strahl ausweichen, oder man fliegt von der Plattform."}}, -- Death Speaker // Todessprecher
	[170486] = {{"Important", "Betäuben Unterbrechen(!!): Hingebungsvolles Opfer (Verwandelt sich in einen gefährlichen Mob)"}}, -- Atal'ai Devoted // Ergebener der Atal'ai
	[170480] = {{"Important", "Stirbt er, dann verwandelt er sich in einen gefährlichen Geist. Lauf weg!"},
				{"Important", "Betäuben Unterbrechen (!): Bladestorm (AoE damage, can also run away)"}}, -- Atal'ai Deathwalker // Todeswandler der Atal'ai
	...
	[164555] = {{"Important", "SEHR hoher Tank Schaden. Defensiv-Fähigkeiten aufheben für hohe Stacks mit Blutung."},
				{"Important", "Erzeugt 'Experimentelle Eichhörnchenbombe' - anklicken zum Entschärfen - werursachen hohen Flächenschaden."},
				{"Important", "Wird man von einem blauen Kreis erfasst, dann nahe zu Millificent laufen, um Sie zu betäuben. Resettet die Blutungen beim Tank."}
				}, -- Millificent Manastorm
	[171181] = {{"Important", "Stackt einen Tank debuff (Schnabelschlitzen). Nicht sehr gefährlich."}}, -- Territorial Bladebeak // Territorialer Klingenschnabel
	[175588] = {{"Important", ""}}, -- Acrobatic Steward
	[167965] = {{"Important", "Unterbrechen (!): Schmieren (Verringert Zauber- und Trefferchance)"},
				{"Important", "Interrupt (!): Selbstreinigungszyklus (Kanalisierter Heal)"}}, -- Lubricator // Schmierer
	[168141] = {{"Important", "In unserem Team... jetzt..."}}, -- Bwonsamdi
	[167963] = {{"Important", "Unterbrechen: Entladung (ST nuke)"},
				{"Important", "Macht eine wirbelnde AoE. Tut nicht sonderlich weh, aber trotzdem Vorsicht."}}, -- Headless Client // Kopfloser Klient
	[169501] = {{"Important", ""}}, -- Shadowlands Wormhole
	[171343] = {{"Important", "Besänftigen: Reizendes Kreischen (AoE dmg wird erhöht)"}, {"Important", "Stackt einen Debuff auf dem Tank, ist aber nicht sehr gefährlich."}}, -- Bladebeak Matriarch // Klingenschnabelmatriarchin
	[170488] = {{"PriorityTargets", "Priority Target"}, {"Important", "Fixiert einen zufälligen Spieler. Hinterlässt eine rote Lache, wenn er stirbt."}}, -- Son of Hakkar // Sohn von Hakkar
	[167967] = {{"Important", "Unterbrechen (!!): Ätherisches Öl (ST Nuke auf zufälligem Ziel)."}}, -- Sentient Oil // Empfindsames Öl
	[168986] = {{"Important", ""}}, -- Skeletal Raptor
	
	[168992] = {{"Dodge", "Dodge die lila Blumen. Casten unterbrechen durch betäuben (Dunkler Lotus)."}}, -- Risen Cultist // Auferstandener Kultist
	[164857] = {{"Important", ""}}, -- Spriggan Mendbender
	[168949] = {{"Important", "Frontal knockback"}}, -- Risen Bonesoldier
	[169912] = {{"Important", ""}}, -- Enraged Mask
	[171341] = {{"Important", "Geringer Tank Schaden."}}, -- Bladebeak Hatchling
	[165905] = {{"PriorityTargets", "Priority Target"}, {"Important", "Fixiert einen zufälligen Spieler. Hinterlässt eine rote Lache, wenn er stirbt."}}, -- Son of Hakkar // Sohn von Hakkar
	[168326] = {{"Important", ""}}, -- Shattered Visage
	[173458] = {{"Important", ""}}, -- Meikothe, Clutch Guardian
	[170483] = {{"Important", ""}}, -- Atal'ai Deathwalker's Spirit
	[171333] = {{"Important", "Betäuben Unterbrechen(!!): Hingebungsvolles Opfer (Verwandelt sich in einen gefährlichen Mob)"}}, -- Atal'ai Devoted // Ergebener der Atal'ai
	[167966] = {{"Important", "Explodiert beim Berühren des Spielers."},
				{"Important", "Ja, festsetzen und Knockbacks funktioniert hier. Mach mit dieser Information, was Dir gefällt."}}, -- Experimental Sludge // Experimenteller Schlick
	[171472] = {{"Important", ""}}, -- Bwonsamdi
	
	----- Sanguine Depths -----
	----- Die blutigen Tiefen ----- 
	[165318] = {{"Important", "Ein Spieler muss den Naaru aufsammeln - gewährt ihm 'Glänzendes Strahlen'. Bei 100 Energie castet der Boss 'Dunkelbö' - hier 'Glänzendes Strahlen' als Counter - alle rein in die Kuppel"},
				{"Important", "Verteilt stehen - Bei 'Tückischer Ansturm' stürmt er mehrere Spieler an und macht AoE."},
				{"Dodge", "'Durchdringendes Verschwimmen': Boss feuert Strahlen ab, unbedingt raus - am Besten in einen abgefeuerten Strahl stellen."},
				{"Important", "Stirbt bei 50% Gesundheit."}}, -- General Kaal // Generalin Kaal
	[162103] = {{"Important", "Bewegt euch von der Gruppe weg, wenn ihr einen roten Kreis durch Züchtigen unter euch bekommt - Achtung hoher Schaden."},
				{"Important", "(Mythic) Zwei Kugeln fliegen in der Arena rum. Eine nahe der äußeren Mauer, die andere nahe der inneren."},
				{"Important", "Ausweichen, indem ihr nach innen/außen lauft - je nachdem welche Kugel bei euch ist."},
				{"Important", "Adds müssen direkt down, je länger sie leben, desto mehr Schaden machen sie und umso größer wird die Pfütze beim Sterben."}}, -- Executor Tarvold // Henker Tarvold
	[166689] = {{"Important", ""}}, -- General Draven
	[162100] = {{"Important", "Während 'Niederwalzen': Alle in einer Reihe stehen, um den Schaden aufzuteilen."},
				{"Important", "Boss an der Wand tanken - castet mit 'Boshafter Kopfstoß' einen Rückstoßeffekt''."},
				{"Important", "Castet 'Trennendes Schmettern': Stößt alle Spieler zurück und jeder hinterlässt eine Kugel."},
				{"Important", "Nach 'Trennendes Schmettern': Alle Kugeln aufsammeln - reinlaufen. Verursachen AoE, also Vorsicht."},
				{"Important", "Die Kugeln heilen den Boss, wenn sie ihn erreichen."},
				{"Interrupts", "Unterbrechen (!!): 'Lechzender Entzug' (AoE Dmg + Boss Dmg Buff)"}}, -- Kryxis the Voracious // Kryxis der Gefräßige
	[162102] = {{"Important", "'Ritus der Vorherrschaft': Sucht nach der goldenen Kuppel auf dem Boden und stellt euch dort hinein, bis der Zauber zu Ende ist"},
				{"Important", "(Mythic): 'Ritus der Vorherrschaft': Es spawnen gelbe Kugeln anstatt des Kreises, 3-4 davon aufsaugen - Reduziert den Schaden, sonst geht es böse aus."},
				{"Dodge", "Den gelben Wirbeln ausweichen - machen ordentlich Schaden."},
				{"TANK", "Defensiv Fähigkeit ziehen während 'Eisenstacheln'."}}, -- Grand Proctor Beryllia // Großaufseherin Beryllia
	[169617] = {{"Important", ""}}, -- Duraka the Unbreakable
	[162040] = {{"PriorityTargets", "Priority Target"}, {"Interrupts", "Unterbrechen (!): Schattenentladung (ST Nuke)"},
				{"Important", "Weglaufen vom Boss, wer Ketten auf sich hat (Schreckensbindungen)"}}, -- Grand Overseer // Oberaufseher
	[166396] = {{"Important", "Betäuben Unterbrechen: Waffe animieren. Waffe verschwindet, wenn der Mob stirbt."}}, -- Noble Skirmisher // Adliger Scharmützler
	[171455] = {{"Important", "Diese erscheinen recht oft - stellen aber keine große Gefahr da."}}, -- Stonewall Gargon // Steinwallgargon
	[174001] = {{"Important", ""}}, -- Anima Collector
	[162099] =  {{"Important", "Ein Spieler muss den Naaru aufsammeln - gewährt ihm 'Glänzendes Strahlen'. Bei 100 Energie castet der Boss 'Dunkelbö' - hier 'Glänzendes Strahlen' als Counter - alle rein in die Kuppel"},
				{"Important", "Verteilt stehen - Bei 'Tückischer Ansturm' stürmt er mehrere Spieler an und macht AoE."},
				{"Dodge", "'Durchdringendes Verschwimmen': Boss feuert Strahlen ab, unbedingt raus - am Besten in einen abgefeuerten Strahl stellen."},
				{"Important", "Stirbt bei 50% Gesundheit."}}, -- General Kaal // Generalin Kaal
	[162057] = {{"Important", "GEFÄHRLICH: Castet kegelförmige AoE nach vorne ('Trennendes Schlitzen') - Von der Gruppe weg tanken."},
				{"Dodge", "Ausweichen: Die braunen Wirbel werden schleudern Dich nach oben."},
				{"Interrupts", "Unterbrechen (!): Steinhaut (Dmg Reduzierung, kann geraubt werden)"}}, -- Chamber Sentinel // Kammerwache
	[168591] = {{"Important", ""}}, -- Ravenous Dreadbat
	[162039] = {{"Interrupts", "Unterbrechen (!): Seelenqual (DoT, kann dispellt werden)"},
				{"Interrupts", "Unterbrechen (!!): Fluch der Unterdrückung (5s Stille)"},
				{"Important", "Auseinander stehen."}}, -- Wicked Oppressor // Tückische Unterdrückerin
	[171448] = {{"Important", "Den Fallen ausweichen."}}, -- Dreadful Huntmaster // Schrecklicher Meisterjäger
	[171799] = {{"Important", ""}}, -- Depths Warden
	[162038] = {{"Important", "Stößt mit seiner Waffe nach vorne. Jeder neue Stoß reaktiviert die vorherigen."},
				{"Important", "Mechanik kann umgangen werden, indem man ihn an einer Stelle tankt und den Stößen ausweicht."},
				{"Important", "Wirkt eine Pfütze, die seinen Schaden erhöht. Nicht wirklich schlimm, wenn man den Stößen ausweicht."}}, -- Regal Mistdancer // Majestätischer Nebeltänzer
	[168882] = {{"Important", ""}}, -- Fleeting Manifestation
	[165076] = {{"Interrupts", "Unterbrechen: Vollfressen (Explodiert beim Tod, je nach Anzahl der Vollfressen Stacks."}}, -- Gluttonous Tick // Gefräßige Zecke
	[171376] = {{"Dodge", "Ausweichen: Tornado ausweichen - verursacht Schaden und stößt zurück."},
				{"Important", "Stärkt eine der Maden um ihn herum - Focus darauf und umkloppen."}}, -- Head Custodian Javlin // Oberverwalter Javlin
	[167956] = {{"Important", ""}}, -- Dark Acolyte
	[162133] =  {{"Important", "Ein Spieler muss den Naaru aufsammeln - gewährt ihm 'Glänzendes Strahlen'. Bei 100 Energie castet der Boss 'Dunkelbö' - hier 'Glänzendes Strahlen' als Counter - alle rein in die Kuppel"},
				{"Important", "Verteilt stehen - Bei 'Tückischer Ansturm' stürmt er mehrere Spieler an und macht AoE."},
				{"Dodge", "'Durchdringendes Verschwimmen': Boss feuert Strahlen ab, unbedingt raus - am Besten in einen abgefeuerten Strahl stellen."},
				{"Important", "Stirbt bei 50% Gesundheit."}}, -- General Kaal // Generalin Kaal
	[162049] = {{"Important", ""}}, -- Vestige of Doubt
	[162047] = {{"Dodge", "Ausweichen: blauer Wirbel - heilt den Mob, wenn er ihn trifft."}}, -- Insatiable Brute // Unersättlicher Schläger
	[171384] = {{"Dodge", "Ausweichen: große Feuer Wirbel."}}, -- Research Scribe // Forschungsschreiberin
	[172265] = {{"Interrupts", "Unterbrechen (!): 'Explosiver Ärger' (AoE damage, erhöht den Spielerschaden, also nicht kicken, wenn man genug Gesundheit hat)"}}, -- Remnant of Fury // Überrest des Zorns
	[162041] = {{"Important", "Falls 'Motiviert', dann Fokus - sonst keine Gefahr."}}, -- Grubby Dirtcruncher // Schmuddeliger Dreckmampfer
	...
	[169753] = {{"Important", "Nicht sonderlich  gefährlich."}}, -- Famished Tick
	[166219] = {{"Important", ""}}, -- General Draven
	[165073] = {{"Important", ""}}, -- Forlorn Captive
	[162046] = {{"Important", "Nicht gefährlich."}}, -- Famished Tick
	[171805] = {{"Dodge", "Ausweichen: große Feuer Wirbel."}}, -- Research Scribe // Forschungsschreiberin
	[168594] = {{"Important", ""}}, -- Chamber Sentinel
	[168058] = {{"Important", ""}}, -- Infused Quill-feather
	[156540] = {{"Important", ""}}, -- Scrawny Rat
	[166589] = {{"Important", "Verschwindet, wenn der Caster stirbt."}}, -- Animated Weapon
	...
	----- Halls of Atonement -----
	----- Hallen der Sühne -----
	[164218] = {{"Dodge", "Der Boss wirft die Statuen durch den Raum, passt auf die roten Pfeile auf - Statuen blicken in die Richtung, in die sie sich bewegen."},
				{"Important", "Ritual des Kummers: Ein Spieler muss sich zwischen dem Boss und der Statue stellen (roter Strahl). Sonst gibt es massiv AoE dmg"},
				{"Important", "Defensiv Zauber während des Rituals ziehen - der Schaden wird auch bei perfektem Spiel hoch sein."},
				{"Important", "Ritual des Kummers: Bei 70% und 40% Gesundheit."},
				{"Important", "Inquisitor Sigar - Ein Miniboss. Tötet alle Seelen im Raum, damit Sigar sich nicht heilt - dann DPS auf ihn."},
				{"HEALER", "Cooldowns aufbewahren für den Schaden von 'Ritual des Kummers'."}}, -- Lord Chamberlain // Oberster Kämmerer
	[165410] = {{"Important", "Wer von einem Geist verfolgt wird - blauer Strahl - hinter ein Gefäß - Geist rennt dort rein."},
				{"Important", "Geister machen AoE um sich herum - Wegbleiben!."},
				{"Interrupts", "Unterbrechen (!!!): Machtsalve (großer  AoE Nuke)"},
				{"Interrupts", "Unterbrechen (!): Machtblitz (mittlerer Nuke auf den Tank)"}}, -- High Adjudicator Aleez // Hochadjudikatorin Aleez
	[165408] = {{"Important", "(Mythic) Im roten Kreis bleiben oder ihr werdet perma ge-feared."},
				{"Important", "Der Srahl kann seine Richtung ändern - in der Mitte von 2 Strahlen bleiben, sodass man sich schnell bewegen kann."},
				{"Important", "(Heroic) Ein zufälliger Spieler wird ge-feared. Dispel den Spieler."},
				{"Important", "Wenn ihr durchs Glas lauft - Defensiv Zauber wirken."}}, -- Halkias // Halkias, der sündenbefleckte Goliath
	[164563] = {{"Important", "Bekommen Enrage vom Hundemeister - diese direkt töten. SEHR hoher Tank Damage."}}, -- Vicious Gargon // Boshafter Gargon
	[167876] = {{"Important", "Inquisitor Sigar - Ein Miniboss. Tötet alle Seelen im Raum, damit Sigar sich nicht heilt - dann DPS auf ihn."}}, -- Inquisitor Sigar
	[156827] = {{"Important", "Wenn 'Steinzerschmetternder Sprung' auf einem ist (Kreis) zu den toten Adds laufen - Boss springt dorthin und zerschmettert diese."},
				{"Important", "Nicht zerschmetterte Adds respawnen."},
				{"Important", "Fokus auf die Adds, zerschmettert diese mit dem Debuff und weg von den roten Pfützen"}}, -- Echelon
	[174175] = {{"Important", "VENTHYR: Acton Button bei den Steingeborenen drücken, um sie zu kontrollieren."},
				{"Important", "Front kegelförmig."}}, -- Loyal Stoneborn // Treuer Steingeborener
	[164557] = {{"Important", "Hauen hat eine große AoE Reichweite - Vorsicht, wenn ihr wenig Leben habt."},
				{"Important", "Fokus auf Splitter, unterbrecht aber Sünden sammeln von den anderen Adds. Dispelled Lebensentzug, um die Heilung zu stoppen."},
				{"Important", "Jeder getötete Splitter liefert Anima, um Halkias zu restaurieren - nach 3 Splittern erscheint der Boss."}}, -- Shard of Halkias // Splitter von Halkias
	[164562] = {{"Interrupts", "Betäuben Unterbrechen (!!): 'Treue Tiere' (fetter Enrage Effekt auf Gargons, besänftigen)"}}, -- Depraved Houndmaster // Verkommener Hundemeister
	[164185] = {{"Important", "Wenn 'Steinzerschmetternder Sprung' auf einem ist (Kreis) zu den toten Adds laufen - Boss springt dorthin und zerschmettert diese."},
				{"Important", "Nicht zerschmetterte Adds respawnen."},
				{"Important", "Fokus auf die Adds, zerschmettert diese mit dem Debuff und weg von den roten Pfützen"}}, -- Echelon
	[165515] = {{"Important", "Front kegelförmig"}}, -- Depraved Darkblade
	[165529] = {{"Interrupts", "Unterbrechen (!!): Sünden sammeln (Beschwört massenhaft Adds)"},
				{"Interrupts", "Unterbrechen (!): Lebensentzug (Entzieht Leben)"}}, -- Depraved Collector // Verkommener Sammler
	[165414] = {{"Interrupts", "Unterbrechen (!): Curse of Obliteration (AoE Shadow Dam around target."}}, -- Depraved Obliterator
	[167610] = {{"Important", "Will bite your ankles and stun you. You can AoE stun them then burn down."}}, -- Stonefiend Anklebiter // Knöchelbeißersteinscheusal
	[165415] = {{"Important", ""}}, -- Toiling Groundskeeper
	[167612] = {{"Important", "Dispel (!!): Steinadern. Wirkt bei 10 Stapeln tödlich."}}, -- Stoneborn Reaver // Steingeborener Häscher
	[167607] = {{"Important", "Front kegelförmig - Nicht vor ihnen stehen - haben einen Rückstoß- und Spalteneffekt."}}, -- Stoneborn Slasher // Steingeborener Schlitzer
	[175588] = {{"Important", ""}}, -- Acrobatic Steward
	[164363] = {{"Important", ""}}, -- Undying Stonefiend
	[165913] = {{"Important", ""}}, -- Ghastly Parishioner
	[167611] = {{"Important", ""}}, -- Stoneborn Eviscerator
	[167892] = {{"PriorityTargets", "Priority target. Töten vor Sigar."}}, -- Tormented Soul
	[167806] = {{"Important", ""}}, -- Animated Sin
	[167615] = {{"Important", ""}}, -- Depraved Darkblade
	[167898] = {{"Important", "Fixiert einen bestimmten Spieler. Kiten und umhauen."}}, -- Manifestation of Envy
	[175577] = {{"Important", ""}}, -- Sinfall Flyer
	
	----- Plaguefall -----
	----- Seuchensturz -----
	[164266] = {{"Important", "No mechanics happening: stay stacked."},
				{"Important", "Schattenhafter Hinterhalt: Kreis auf einem Spieler - weg von der Gruppe."},
				{"Important", "Castet 'Brutassassinen' - In die Netze rennen, AoE/Knockbacks casten, um die Spinnen herauszulocken - diese zum Tank."},
				{"Important", "Fokus auf die Spinnen - diese sind sehr gefährlich."},
				{"Important", "Falls ein Spieler eingenetzt wird -> SOFORT mit Schaden das Netz zerstören."}}, -- Domina Venomblade // Domina Giftklinge
	[164967] = {{"Important", "Seuchenbombe: Kompletter Fokus, damit es seinen Zauber nicht durch bekommt."},
				{"Important", "'Geronnener Schleim' weg tanken  von der Seuchenbombe - reduziert den Schaden um 75%."},
				{"Important", "Trash von den Plattformen umkloppen. Boss springt zwischen den Plattformen hin und her."}}, -- Doctor Ickus
	[164267] = {{"Important", "Tentakel erscheinen in der Mitte - unbedingt dem Seuchenschmettern der Tentakel ausweichen."},
				{"Important", "Tötet immer das Add, welches im Kampf erscheint. Es hinterlässt eine grüne Pfütze durch Schleimberührung, die vom Tank aufgesaugt werden muss, sonst explodiert diese."},
				{"Important", "Fokus aufs Überleben - der Boss hat nicht sonderlich viel Leben, aber die Mechanik ist nicht Ohne."}}, -- Margrave Stradama // Markgräfin Stradama
	[174195] = {{"Important", ""}}, -- Hairball
	[164255] = {{"Dodge", "Ausweichen: Schleimwelle: Kegelförmiger Angriff auf zufälligen Spieler - Steht nah am Boss, um dem Angriff gut ausweichen zu können."},
				{"Important", "Der große Schleim MUSS getötet werden, sobald er spawnt. CC ist möglich - darf auf keinen Fall den Boss berühren."},
				{"Important", "Ist der große Schleim down, dann soviele kleine wie mögliche umhauen."}}, -- Globgrog
	[163857] = {{"Important", "FETTER tank Damage, aber langsam - leicht zu kiten."},
				{"Important", "Ickor wird einen davon buffen. Verlangsamen und kiten."}}, -- Plaguebound Devoted // Seuchengebundene Ergebene
	[163892] = {{"Important", ""}}, -- Rotting Slimeclaw
	[168969] = {{"Important", "Nicht wirklich gefährlich."}}, -- Gushing Slime
	[165357] = {{"Important", ""}}, -- Pestilence Slime
	[163894] = {{"Dodge", "Ausweichen: Front kegelförmig: Festering Belch (tank can dodge after cast start"}}, -- Blighted Spinebreaker
	...
	[169498] = {{"PriorityTargets", "Prio Target. Muss fallen, bevor der Zauber durch ist."}}, -- Plague Bomb // Seuchenbombe
	[163882] = {{"Interrupts", "Unterbrechen: Gruselige Kriecher (Ruft Adds)"}}, -- Decaying Flesh Giant // Verwesender Fleischriese
	[168153] = {{"Important", "Stößt den Tank zurück. Nicht am Rand tanken."}}, -- Plagueroc // Seuchenroc
	[168396] = {{"Beschwört Schleim, der sich zu ihm bewegt und ihn heilt - Fokus Feuer darauf - kann CC'd werden."}}, -- Plaguebelcher // Seuchenspucker
	[171474] = {{"Important", ""}}, -- Finger Food
	[168878] = {{"Important", "Jagt sich selbst in die Luft. Fügt Gegnern und Verbündeten in der Nähe Schaden zu."}}, -- Rigged Plagueborer // Manipulierter Seuchenbohrer
	[173840] = {{"Important", ""}}, -- Plaguebound Devoted
	[168310] = {{"Important", "Stößt den Tank zurück. Nicht am Rand tanken."}}, -- Plagueroc // Seuchenroc
	[170474] = {{"Important", "Mit AoE aus dem Stealth holen und dann Fokus Feuer drauf."}}, -- Brood Assassin // Brutassassine
	[171887] = {{"Important", ""}}, -- Slimy Smorgasbord
	[164737] = {{"Important", "Versteckt Tarnlinge in der Umgebung. Ihr müsst sie mit AoE CC'en - sonst gibt es Nuke auf einen zufälligen Spieler."},
				{"Important", "Einhüllende Netze ist ein kanalisierter Zauber, der nicht gefährlich ist."}}, -- Brood Ambusher // Brutwegelagerer
	[168578] = {{"Interrupts", "Unterbrechen (!): Wonder Grow (dmg buff, stealable)"}}, -- Fungalmancer
	[168572] = {{"Important", "Castet einen kanalisierten Klingensturm. CC in Betracht ziehen, denn ausweichen wird schwer ohne andere Mobs zu pullen."}}, -- Fungi Stormer // Fungistürmer
	[163862] = {{"Interrupts", "Betäuben Unterbrechen (!): Bollwerk von Maldraxxus (Bubble, die Schadem um 90% verringert)"}}, -- Defender of Many Eyes // Verteidiger der vielzähligen Augen
	[165430] = {{"Important", ""}}, -- Malignant Spawn
	[163915] = {{"Important", ""}}, -- Hatchling Nest
	[169696] = {{"Important", ""}}, -- Mire Soldier
	[168837] = {{"Important", ""}}, -- Stealthling
	[169861] = {{"Important", "Springt zwischen den Gruppen hin und her, wenn er wenig Leben hat. Ihr könnt auch auf das töten der Skelette konzentrieren."}}, -- Ickor Bileflesh // Ickor Gallenfleisch
	[168393] = {{"Beschwört Schleim, der sich zu ihm bewegt und ihn heilt - Fokus Feuer darauf - kann CC'd werden."}}, -- Plaguebelcher // Seuchenspucker
	[167493] = {{"Important", ""}}, -- Venomous Sniper
	[169501] = {{"Important", ""}}, -- Shadowlands Wormhole
	[168361] = {{"Important", ""}}, -- Fen Hornet
	[168022] = {{"Important", "Schnappt sich den Tank. Nicht mit zuviel anderen Mobs pullen - ansonsten recht einfach."}}, -- Slime Tentacle // Schleimtentakel
	[164705] = {{"Important", ""}}, -- Pestilence Slime
	[169159] = {{"Important", "Explodiert im Tod. Trifft gegnerische Mobs!"}}, -- Unstable Canister
	...
	[164707] = {{"PriorityTargets", "Prio target. Castet 'Geronnene Ansteckung' - Verringert den Schaden von Verbündeten um 75%"}}, -- Congealed Slime // Geronnener Schleim
	[168891] = {{"Important", ""}}, -- Rigged Plagueborer
	[169421] = {{"Important", ""}}, -- Felguard
	[168968] = {{"Important", ""}}, -- Plaguebound Fallen
	[168907] = {{"Important", "Schnappt sich den Tank. Nicht mit zuviel anderen Mobs pullen - ansonsten recht einfach."}}, -- Slime Tentacle // Schleimtentakel
	...
	[173360] = {{"Important", "Beschwört Schleim, der sich zu ihm bewegt und ihn heilt - Fokus Feuer darauf - kann CC'd werden."}},
	[173339] = {{"Important", "Beschwört Schleim, der sich zu ihm bewegt und ihn heilt - Fokus Feuer darauf - kann CC'd werden."}},
	[172335] = {{"Important", "Beschwört Schleim, der sich zu ihm bewegt und ihn heilt - Fokus Feuer darauf - kann CC'd werden."}},
	...
	[162329] = {{"Important", "Banner der Unterdrückung - Sofort zerstören, da es verlangsamt - erschwert den restlichen Kampf."},
				{"Important", "Schmetterhieb und Massives Spalten: Zwei Angriffe mit großflächigen Markierungen auf dem Boden - Ausweichen."},
				{"Important", "Bei 100 Energie castet der Boss 'Blut und Ruhm': Zwei DPS müssen sich duellieren. Sieger verursacht mehr Schaden, Verlierer weniger. Lasst den stärkeren DPS gewinnen."},
				{"Important", "In M0 geht das Duell bis zum Tod."},
 				{"HEALER", "Der 'Seismische Sprung' fügt der Gruppe beim erstmaligen Wirken der 'Macht von Maldraxxus' erheblichen Schaden zu."}}, -- Xav the Unfallen // Xav der Unbesiegbare
	[162309] = {{"Important", "Eure Seele wird vom Körper gerissen. Ihr erleidet starken Schaden, bis Ihr sie wieder erlangt."},
				{"Important", "Spieler, die von 'Seele entziehen' betroffen sind stellen sich hinter die grüne Fläche. Seele läuft in Richtung Boss und bleibt bei den Packenden Händen stecken."},
				{"Important", "Holt die Seele nach der Betäubung dann ab - Spieler erhalten kurz einen mächtigen Schadensbuff."},
				{"Important", "(Mythic) Betroffene Spieler erhalten den Debuff 'Besessenheit' und greifen das eigene Team an'."},
				{"Important", "Tank immer dicht am Boss, sonst erhält er den DoT 'Spektralreichweite'."},
				{"Important", "Dispel (!!): 'Phantomparasit' wird auf zufälligen Spieler gewirkt - verursacht Flächenschaden - Team etwas verteilt stellen."},
				}, -- Kul'tharok
	[165946] = {{"Important", "(Mythic) Höchst gefährlich: Ab 50% Leben spawnen Geisterpferde, die durch den Raum laufen."},
				{"Important", "(Mythic) Platziert euch nahe einer Wand und weicht auf jeden Fall aus - Ausweichen hat höchste Prio."},
				{"Dodge", "Ausweichen: Dem grünen Strahl von 'Dunkle Verwüstung' ausweichen, der in eine zufällige Richtung geschossen wird."},
				{"Important", "Greifender Riss: Riss erscheint auf dem Boden - dagegen anlaufen, sonst werdet ihr betäubt und erleidet massiv Schaden."}}, -- Mordretha, the Endless Empress // Mordretha, die unendliche Kaiserin
	[164451] = {{"Important", "Empfohlene Kill Reihenfolge: Sathel -> Paceran -> Dessia"},
				{"Important", "Alle 3 Bosse werden gleichzeitig bekämpft"},
				{"Important", "Unter 30%: Geht in Enrage/Wutanfall + Fixiert einen zufälligen Spieler - weglaufen. Wuteffekt kann mit Besänftigen entfernt werden."}
				}, -- Dessia the Decapitator // Dessia die Enthaupterin
	[162317] = {{"Dodge", "Ausweichen: Auf einer Seite des Raums erscheinen eine Reihe von Fleischerhaken. In dieser Reihe ist ein Loch, wo ihr durchlaufen könnt, wenn die Haken durch den Raum fliegen."},
				{"Important", "Boss wird einen manchmal pullen, bevor die Haken kommen - Schnell die Lücke finden."},
				{"Important", "Es erscheinen Adds, wenn die Haken kommen: Im Zentrum killen - hinterlassen tödliche Pfütze."},
				{"Important", "Ranziger Gasbeutel: Ausweichen 'Abscheulicher Ausbruch' macht Schaden vor und hinter dem Gegner"}
				}, -- Gorechop // Bluthack
	[170690] = {{"Important", "Krankheit: Zersetzende Seuche - Reduziert Tank Leben um 5% per Stack."},
				{"Interrupts", "Unterbrechen: Fleischschild (Schadens-Absorption)"}}, -- Diseased Horror // Kranker Schrecken
	[170850] = {{"Important", "Besänftigen: 'Rasender Tobsuchtsanfall' (AoE kanalisierter Schaden)."},
				{"Important", "Ausweichen 'Hornansturm' - gibt Schaden und Betäubung. Hat eine 2s Zauber Zeit."}}, -- Raging Bloodhorn // Tobendes Bluthorn
	[164461] = {{"Important", "Empfohlene Kill Reihenfolge: Sathel -> Paceran -> Dessia"},
				{"Important", "Alle 3 Bosse werden gleichzeitig bekämpft"},
				{"Important", "Unter 30%: Castet Schild 'Eins mit dem Tod' - Kann 30 Sekunden lang nicht getötet werden kann."},
				{"Important", "Castet 'Spektrale Übertragung' auf einen Verbündeten (grüner Strahl) - Dispel - Verbündeter wird sonst geheilt"},
				{"Important", "Fokussierern und umhauen, sobald das Schild weg ist."}
				}, -- Sathel the Accursed // Sathel der Verfluchte
	[164463] = {{"Important", "Empfohlene Kill Reihenfolge: Sathel -> Paceran -> Dessia"}, 
				{"Important", "Alle 3 Bosse werden gleichzeitig bekämpft"},
				{"Important", "Unter 30%: Spieler erhalten Debuff, sodass Pilze bei ihnen spawnen - raus dort."},
				{"Important", "Encounter Warnung: (Mythic)? Xira ist im Stealth und wirkt 'Zusätzliche Angriffe' auf einen zufälligen Spieler - Dieser wird betäubt und erleidet mass Schaden. CC sie, um es zu brechen."}
				}, -- Paceran the Virulent // Paceran der Virulente
	[164464] = {{"Important", "Macht Betäubung und Schaden auf bel. Spieler - CC sie, um es zu brechen."}}, -- Xira the Underhanded // Xira die Hinterlistige
	[175588] = {{"Important", ""}}, -- Acrobatic Steward
	[174210] = {{"Interrupts", "Unterbrechen (!!): Verdorrender Ausstoß (AoE Krankheit, die Schaden / Heilung reduziert)."}}, -- Blighted Sludge-Spewer // Verseuchter Schlickspeier
	[164506] = {{"PriorityTargets", "Priority Target"},
				{"Important", "Gibt Verbündeten eine Aura, die AoE Schaden reduziert."}}, -- Ancient Captain // Uralter Hauptmann
	[174197] = {{"Important", "Nekrotischer Blitz: Ziel erleidet Schaden und Heilung beim Ziel wird absorbiert - einfach durchheilen."},
				{"Interrupts", "Unterbrechen (!): Unheilige Inbrunst (bufft Verbündete: Heilung, wenn diese Schaden verursachen)"}}, -- Battlefield Ritualist // Schlachtfeldritualist
	[169927] = {{"Interrupts", "Betäuben Unterbrechen: Fleisch verschlingen (Entzieht Leben)"}}, -- Putrid Butcher // Eitriger Schlächter
	[170838] = {{"Important", "Besänftigen:: Todeswunsch (+20% Dmg auf Ziel, +20% Physischer Dmg für den Caster)"}}, -- Unyielding Contender // Unerschütterlicher Streiter
	[170882] = {{"Interrupts", "Betäuben Unterbrechen (!!): Knochenspeer (dicker Blutungseffekt - direkt tödlich auf hohen Keys)"}}, -- Bone Magus // Knochenmagus
	[165260] = {{"Important", ""}}, -- Oozing Leftovers
	[169875] = {{"Important", "Rausziehen aus dem Bereich und ihr müsst den Pfützen nicht ausweichen!"},
				{"Interrupts", "Unterbrechen: Seelenberührung (Hoher Schaden auf zufälligem Ziel)"}}, -- Shackled Soul // Gefesselte Seele
	...
	[163086] = {{"Important", "Abscheulicher Ausbruch: Raus aus dem kegelförmigen Front/Hinteren Bereich... Weicht zur Seite aus."}}, -- Rancid Gasbag // Ranziger Gasbeutel
	-- [162744] = {{"Important", "Castet Unterbrechendes Brüllen: Unterbricht alle Zauber - Instants nutzen."}}, -- Nekthara // Nekthara der Zerfleischer
	[167998] = {{"Important", "Seelensturm ist ein fetter, furchteinflößender AoE. CDs für Verteidigung und Heilung ziehen."},
				{"Important", "Dispel (Curse): Wirkt Schattenverwundbarkeit auf Spieler."}}, -- Portalwächter
	[169893] = {{"Important", "Castet Todeswinde: Das WIRD dich umhauen - Auf jeden Fall ausweichen."},
				{"Important", "Dispel: Fluch der Trostlosigkeit (Alle 3s erscheint eine Schadensfläche unter den Füßen)"}}, -- Nefarious Darkspeaker // Ruchloser Dunkelsprecher
	[162744] = {{"Important", "Castet Unterbrechendes Brüllen: Unterbricht alle Zauber - Instants nutzen."},
				{"Dodge", "Ausweichen: : Wirbelnde Klinge (brauner Wirbel)"}}, -- Nekthara // Nekthara der Zerfleischer
	[167532] = {{"Important", "Castet Unterbrechendes Brüllen: Unterbricht alle Zauber - Instants nutzen."},
				{"Dodge", "Ausweichen: Bodenzerkracher - Betäubt (Wirbel)"}}, -- Heavin the Breaker // Wuchtus der Brecher
	[167536] = {{"Important", "Wer einen roten Kreis auf sich hat - weg von Verbündeten."},
			{"Interrupts", "Unterbrechen (!!): Kampftrance (Schadensabsorption und höhere Angriffsgeschw.)"}}, -- Harugia the Bloodthirsty // Harugia die Blutrünstige
	[167534] = {{"Important", "Kampf ist schnörkellos, aber hoher Schaden auf den Tank und mäßiger auf die Gruppe."}}, -- Rek the Hardened // Rek die Gehärtete
	

	
	----- Necrotic Wake -----
	----- Die nekrotische Schneise -----
	[166945] = {{"Important", "Kometenhagel hinterlässt Wirbel. Immer rausrennen - diese verursachen sehr hohen Schaden."},
				{"Important", "Wenn ein Spieler gerootet ist: Alle rausrennen aus dem Kreis und dann Dispel. DISPEL NICHT ZU FRÜH."},
				{"Important", "Ein Spieler wird zum Spießrutenlauf verbannt. Schnell bis ans Ende laufen, den Miniboss unterbrechen und umhauen - der Engel dort portet Euch zurück"},
				{"Important", "(Mythic) Der Spieler im Lauf erhält Stacks von 'Eisige Kälte' - Diese müssen oben in einer Ecke abgelegt werden - sonst vereist die gesamte Platform."}
				}, -- Nalthor the Rimebinder // Nalthor der Eisbinder
	[166882] = {{"Important", "Ein Spieler wird von Fleischerhaken vom Add anvisiert. Dieser muss sich vor die Bossplattform stellen"},
				{"Important", "und kurz vor Einsatz des Angriffs zur Seite weglaufen, damit der Haken den Boss von der Plattform zieht."},
				{"Important", "Greift danach den Boss an. - Der Boss bleibt 30s und geht dann zurück auf die Platform."},
				{"Important", "Zwei Adds sind kaum zu schaffen - erscheint das 2. dann Fokus auf das erste und max DPS."},
				{"Dodge", "Ausweichen: Boss wirkt Einbalsamierungssekret - raus aus den grünen Pfützen."},
				}, -- Surgeon Stitchflesh // Chirurg Fleischnaht
	[166880] = {{"Important", "Pullt den Boss erst, wenn genug Platz im Raum ist, da man sich viel bewegen muss."},
				{"Important", "Wirkt 'Erbrechendes Würgen' kegelförmig vor ihm - erzeugt dabei Würmer"},
				{"Important", "Tötet die Würmer und verlangsamt sie. Rennt weg - sie müssen schnell sterben, sonst schafft ihr den Boss nicht"},
				{"Important", "Berühren euch die Würmer 3 mal, dann explodieren sie und machen großen Schaden."},
				{"Important", "Wirkt 'Fauliges Gas' - hinterlässt grüne Pfützen - raus da."},
				{"Important", "Boss weg ziehen von den grünen Pfützen, damit die DPS raum zum kiten der Würmer haben."}
				}, -- Blightbone // Pestknochen
	[163157] = {{"Important", "Fokus auf die Adds und töten bevor er 'Letzte Ernte' castet."},
				{"Important", "Adds: Nekromanten zuerst Down - nicht die Skelettdiener."},
				{"Important", "'Letzte Ernte': Leichen explodieren - Schaden im Radius darum / Lebende Mobs explodieren - jeder in der Gruppe erhält Schaden."},
				{"Important", "Betroffene von 'Finsteres Schicksal' (grüner Kreis) aus der Gruppe laufen."},
				{"Interrupts", "Unterbrechen (!): Frostblitzsalve (Adds, Nekromanten)"},
				{"Dodge", "Ausweichen: Nekrotischer Hauch. Rotiert in eine Richtung."},
				{"Important", "(Mythic) Mehr Adds und die Nekromaten casten Frostblitzsalve."},
				}, -- Amarth // Amarth <Der Ernter>
	[171750] = {{"Important", ""}}, -- Malfunctioning Goliath
	[164479] = {{"Important", ""}}, -- Bonefang
	[162693] = {{"Important", "Kometenhagel hinterlässt Wirbel. Immer rausrennen - diese verursachen sehr hohen Schaden."},
				{"Important", "Wenn ein Spieler gerootet ist: Alle rausrennen aus dem Kreis und dann Dispel. DISPEL NICHT ZU FRÜH."},
				{"Important", "Ein Spieler wird zum Spießrutenlauf verbannt. Schnell bis ans Ende laufen, den Miniboss unterbrechen und umhauen - der Engel dort portet Euch zurück"},
				{"Important", "(Mythic) Der Spieler im Lauf erhält Stacks von 'Eisige Kälte' - Diese müssen oben in einer Ecke abgelegt werden - sonst vereist die gesamte Platform."}
				}, -- Nalthor the Rimebinder // Nalthor der Eisbinder
	[162691] = {{"Important", "Pullt den Boss erst, wenn genug Platz im Raum ist, da man sich viel bewegen muss."},
				{"Important", "Wirkt 'Erbrechendes Würgen' kegelförmig vor ihm - erzeugt dabei Würmer"},
				{"Important", "Tötet die Würmer und verlangsamt sie. Rennt weg - sie müssen schnell sterben, sonst schafft ihr den Boss nicht"},
				{"Important", "Berühren euch die Würmer 3 mal, dann explodieren sie und machen großen Schaden."},
				{"Important", "Wirkt 'Fauliges Gas' - hinterlässt grüne Pfützen - raus da."},
	...
	[162729] = {{"Important", "Leichter Mob. Zieh 20 von denen, bevor dir das AoE Damage Cap auffällt."}}, -- Patchwerk Soldier
	[162689] = {{"Important", "Ein Spieler wird von Fleischerhaken vom Add anvisiert. Dieser muss sich vor die Bossplattform stellen"},
				{"Important", "und kurz vor Einsatz des Angriffs zur Seite weglaufen, damit der Haken den Boss von der Plattform zieht."},
				{"Important", "Greift danach den Boss an. - Der Boss bleibt 30s und geht dann zurück auf die Platform."},
				{"Important", "Zwei Adds sind kaum zu schaffen - erscheint das 2. dann Fokus auf das erste und max DPS."},
				{"Dodge", "Ausweichen: Boss wirkt Einbalsamierungssekret - raus aus den grünen Pfützen."},
				}, -- Surgeon Stitchflesh // Chirurg Fleischnaht
	[165824] = {{"Dodge", "Ausweichen: Todesexplosion (Stille + Schaden). Große Grüne Bälle."},
				{"Important", "Reinigen / Stehlen: Dunkler Schleier (Phys Immunität, AoE Damage)"}}, -- Nar'zudah
	[165137] = {{"Important", "Castet einen DoT, der stackt. Wird er dispellt, dann springt er auf ein neues Ziel."},
				{"HEALER", "Dispel (ca. 10-12 Secs cooldown), um den Schaden niedrig zu halten."}}, -- Zolramus Gatekeeper // Torwächter von Zolramus
	[162692] = {{"Important", "Fokus auf die Adds und töten bevor er 'Letzte Ernte' castet."},
				{"Important", "Adds: Nekromanten zuerst Down - nicht die Skelettdiener."},
				{"Important", "'Letzte Ernte': Leichen explodieren - Schaden im Radius darum / Lebende Mobs explodieren - jeder in der Gruppe erhält Schaden."},
				{"Important", "Betroffene von 'Finsteres Schicksal' (grüner Kreis) aus der Gruppe laufen."},
				{"Interrupts", "Unterbrechen (!): Frostblitzsalve (Adds, Nekromanten)"},
				{"Dodge", "Ausweichen: Nekrotischer Hauch. Rotiert in eine Richtung."},
				{"Important", "(Mythic) Mehr Adds und die Nekromanten casten Frostblitzsalve."},
				}, -- Amarth // Amarth <Der Ernter>
	[163121] = {{"Interrupts", "Betäuben Unterbrechen: Fleischschild (absorb)"},
				{"Important", "Besänftigen: Siedende Wut (Attack spd, stackt)"}}, -- Stitched Vanguard // Zusammengeflickte Vorhut
	[172981] = {{"PriorityTargets", "Priority Target."}, 
				{"Important", "Stackt Damage Debuff auf Tank - Tank kriegt mehr Schaden."}}, -- Kyrian Stitchwerk // Kyrianisches Flickwerk
	[165919] = {{"Interrupts", "Unterbrechen (!!): 	Krächzender Schrei (AoE Fear)"},
				{"Important", "Frontal Aufteilen"}}, -- Skeletal Marauder // Skelettmarodeur
	[163618] = {{"PriorityTargets", "Priority Target. Diener sterben, wenn er stirbt."},
				{"Important", "Finsteres Schicksal: grüner Kreis - aus der Gruppe laufen."}}, -- Zolramus Necromancer // Nekromant von Zolramus
	[164702] = {{"Important", ""}}, -- Carrion Worm
	[166302] = {{"Important", ""}}, -- Corpse Harvester
	[173016] = {{"Interrupts", "Unterbrechen (!!): Flüssigkeiten entziehen (ST Stun)"},
				{"Interrupts", "Unterbrechen (!): Blutspritzer (AoE DoT)"}}, -- Corpse Collector // Leichensammler
	[164578] = {{"Important", ""}}, -- Stitchflesh's Creation
	[165872] = {{"Important", "Haken auf zufälligen Spieler. Hinter Monster stellen, dann wird dieses getroffen."},
				{"Interrupt", "Unterbrechen (!): Fleisch reparieren (Heilt loyale Kreation)"}}, -- Flesh Crafter // Fleischformer
	[171095] = {{"Important", ""}}, -- Grisly Colossus
	[167731] = {{"Important", "Haken auf zufälligen Spieler. Hinter Monster stellen, dann wird dieses getroffen."},
				{"Important", "Weglaufen, wenn fixiert."}}, -- Separation Assistant
	[174783] = {{"Important", ""}}, -- Opeth
	[163621] = {{"Important", "Stacks damage taken increase on tank."},
				{"Important", "Frontal Aufteilen"}}, -- Goregrind
	...
	[165197] = {{"Important", "Very large tank damage due to stacking debuff. Pop DPS cooldowns and kill quickly."},
				{"Dodge", "Dodge: blaue Pfützen"}}, -- Skeletal Monstrosity // Skelettmonstrum
	[163128] = {{"Important", ""}}, -- Zolramus Sorcerer
	[168246] = {{"Important", ""}}, -- Reanimated Crossbowman
	[175588] = {{"Important", ""}}, -- Acrobatic Steward
	[163619] = {{"Interrupts", "Betäuben Unterbrechen (!): Boneflay (reduces tank MaxHP)"}}, -- Zolramus Bonecarver
	[173044] = {{"Important", "Haken auf zufälligen Spieler. Hinter Monster stellen, dann wird dieses getroffen."},
				{"Important", "Unterbrechen (!!): Flüssigkeiten entziehen (ST Stun)"}}, -- Stitching Assistant
	[163620] = {{"Important", "Drops poison cloud. Not dangerous for miniboss."}}, -- Rotspew
	[166266] = {{"Important", "Harmlos."}}, -- Spare Parts
	[165911] = {{"Important", "Geht in Enrage, wenn Fleischformer zuerst stirbt. Besänftigen."}}, -- Loyal Creation // Loyale Kreation
	[164427] = {{"Important", ""}}, -- Reanimated Warrior
	[164414] = {{"Important", ""}}, -- Reanimated Mage
	[165222] = {{"Interrupts", "Unterbrechen (!!): Final Bargain (huge heal)"},
				{"Interrupts", "Unterbrechen (!): Bonemend (small heal)"}}, -- Zolramus Bonemender
	[163126] = {{"Interrupts", "Unterbrechen (!): Frostbolt Volley (AoE damage)"}}, -- Brittlebone Mage
	...
	[167410] = {{"Dodge", "Ausweichen: Stürmt einen Spieler an - Verursacht Schaden an allen, die im Weg stehen."},
				{"Important", "Während P2 geht der Boss in die Luft. Kugeln einsammeln und in die Mitte zum Speer bringen."},
				{"Important", "Wurden alle Kugeln gesammelt, dann kann der Speer auf den Boss geworfen werden, damit er wieder runter kommt."},
				{"Important", "Weg von der schwarzen Kugel Abgründige Detonation, da sie nach kurzer Zeit explodiert."},
				{"Important", "(Mythic) Eine Kuppel erscheint - dort rein wenn die Explosion kommt, sonst seid ihr tot."},
				{"HEALER", "Dispel auf Cooldown in P2. Dispelled Nagender Zweifel auf zufälligen Spielern. Eine Pfütze entsteht unter ihnen, raus dort."}
				}, -- Devos // Devos, Paragon des Zweifels
	[162060] = {{"Important", "Stellt euch mindestens 8 Meter auseinander, um zu verhindern, dass mehrere Gruppenmitglieder von Läuternde Druckwelle getroffen werden."},
				{"Important", "Dispelled den Tank nachdem Geladenes Stampfen eingesetzt wurde - verlangsamt ihn."},
				{"Important", "Wer einen blauen Kreis auf sich hat - weg von Verbündeten. Daraus entsteht eine Pfütze (Animafeld) - raus da - Pfützen nach Möglichkeit an einem Ort sammeln - weg vom Boss."},
				{"Important", "Boss von den blauen Pfütze/Animafeld fernhalten."},
				{"Important", "Boss castet Anima wiederaufladen: Aus den Pfützen werden Kugeln - diese einsammeln - dürfen den Boss nicht erreichen"},
				{"Important", "Boss stampft auf den Tank - weg vom Tank."},
				{"Important", "(Mythic) Aufheben einer Kugel gibt einen Debuff - am Besten Tank nimmt alle, oder jeder nimmt eine"}
				}, -- Oryphrion // Oryphrion <Der Dunkle Koloss>
	[162058] = {{"Important", "Überlebenswichtig: Raus aus den dunklen Flächen von Schattenwirbel und weicht den dunklen Geschossen aus, die dort herauskommen."},
				{"Important", "Weicht dem Frontalangriff Blendendes Licht aus - Betäubungseffekt"},
				{"TANK", "Blendendes Licht: Ausweichen, wenn der Boss den Zauber ansetzt."},
				{"HEALER", "'Dunkler Schritt' Ziele erhalten einen massiven DoT. Sie benötigen sehr viel Heilung."}}, -- Ventunax
	[162059] = {{"Dodge", "Überlebenswichtig: Den schwarzen Geschossen von Azules unbedingt ausweichen"},
				{"Important", "Je weiter weg vom Vogel - umso einfacher ist das Ausweichen."},
				{"Important", "Wer 'Geladener Speer' auf sich hat - raus aus der Gruppe."},
				{"Important", "Die Gesundheit der Bosse ist geteilt - also schön fett die DoTs verteilen und Schaden auf jeden wirken."}}, -- Kin-Tara
	[163077] = {{"Important", ""}}, -- Azules
	[163506] = {{"Important", "Getarnter Mob, der einen Blutungseffekt wirkt - Tank vorgehen lassen."}}, -- Forsworn Stealthclaw // Schleichklaue der Verschmähten
	[162061] = {{"Dodge", "Ausweichen: Stürmt einen Spieler an - Verursacht Schaden an allen, die im Weg stehen."},
				{"Important", "Während P2 geht der Boss in die Luft. Kugeln einsammeln und in die Mitte zum Speer bringen."},
				{"Important", "Wurden alle Kugeln gesammelt, dann kann der Speer auf den Boss geworfen werden, damit er wieder runter kommt."},
				{"Important", "Weg von der schwarzen Kugel Abgründige Detonation, da sie nach kurzer Zeit explodiert."},
				{"Important", "(Mythic) Eine Kuppel erscheint - dort rein wenn die Explosion kommt, sonst seid ihr tot."},
	...
	[163503] = {{"Important", "Wirft Projektile und DoTted den Tank. Keine wirkliche Gefahr."}}, -- Etherdiver // Äthertaucher
	[168318] = {{"Interrupts", "Unterbrechen (!!): Rebellische Faust (AoE)"},
				{"Important", "Burst auf Mob während Anima wiederaufladen, um das Schild runter zu kriegen."}}, -- Forsworn Goliath // Goliath der Verschmähten
	[171456] = {{"Important", ""}}, -- Shattered Devastator
	[163520] = {{"PriorityTargets", "Priority Target"},
				{"Important", "Hat eine Aura - Gegner in der Nähe haben 75% weniger AoE Dmg."}}, -- Forsworn Squad-Leader // Schwadronsführer der Verschmähten
	[169501] = {{"Important", ""}}, -- Shadowlands Wormhole
	[168681] = {{"Important", "AoEs und verteilt Zonen der Leere auf dem Boden."}}, -- Forsworn Helion // Ausgeburt der Verschmähten
	[163457] = {{"Important", "Frontal Aufteilen"}}, -- Forsworn Vanguard
	[163459] = {{"Interrupts", "Unterbrechen (!!): Doktrin der Verschmähten (HoT, kann man reinigen / stehlen)"},
				{"Important", "Reinigen: Waffe verzaubern (Arkanschaden bei Autoattack)"}}, -- Forsworn Mender // Heiler der Verschmähten
	[163458] = {{"Interrupts", "Unterbrechen (!): Bürde des Wissens (DoT)"}}, -- Forsworn Castigator // Züchtigerin der Verschmähten
	[168718] = {{"Interrupts", "Unterbrechen (!!): Große Besserung (AoE Heal)"},
				{"Important", "Reinigen / Stehlen: Waffe segnen (Dmg + Heal beim Angriff)"}}, -- Forsworn Warden // Wärter der Verschmähten
	[168420] = {{"Important", ""}}, -- Forsworn Champion
	[163524] = {{"Dodge", "Ausweichen: Schnelles Schlitzen. Gewirkt auf zufälligen Spieler."}}, -- Kyrian Dark-Praetor // Prätor der Dunkelkyrianer
	[168845] = {{"Important", "Einen nach dem anderen pullen - Debuffs auslaufen lassen!"},
				{"Dodge", "Ausweichen: Schwarze Wirbel (Geladener Speer)"}}, -- Astronos // Astronos <Die verknüpften Schicksale>
	[168843] = {{"Important", "Einen nach dem anderen pullen - Debuffs auslaufen lassen!"},
				{"Important", "Stackt einen DoT auf die Gruppe."}}, -- Klotos // Klotos <Die verknüpften Schicksale>
	[168844] = {{"Important", "Einen nach dem anderen pullen - Debuffs auslaufen lassen!"},
				{"Important", "Stackt einen Dmg Debuff auf die Gruppe.."}}, -- Lakesis
	[168418] = {{"Interrupts", "Unterbrechen: Dunkle Peitsche (tank dmg)"},
				{"Interrupts", "Unterbrechen: Innere Zwietracht (DoT auf zufälligen Spieler - macht AoE"}}, -- Forsworn Inquisitor // Inquisitorin der Verschmähten
	[168717] = {{"Important", ""}}, -- Forsworn Justicar
	[165714] = {{"Important", ""}}, -- Kyrestia the Firstborne
	[163501] = {{"Important", "Speer auf zufälliges Ziel."}}, -- Forsworn Skirmisher // Scharmützler der Verschmähten
